        ...
        st = {
            ...
            modifiers: {
                ...
                oj2f_arrow: {
                    ...
                    enabled: !0,
                    fn: function(t, n) {
                        if (!M(t.instance.modifiers, "oj2f_arrow", "keepTogether")) return t;
                        var o = n.element;
                        if ("string" == typeof o) {
                            if (!(o = t.instance.popper.querySelector(o))) return t
                        } else if (!t.instance.popper.contains(o)) return console.warn("WARNING: `oj2f_arrow.element` must be child of its popper element!"), t;
                        ...
                        return _ = Math.max(Math.min(s[u] - m, _), 0), t.oj2f_arrowElement = o, t.offsets.oj2f_arrow = {}, t.offsets.oj2f_arrow[c] = Math.round(_), t.offsets.oj2f_arrow[h] = "", t
                    },
                    element: "[x-oj2f_arrow]"
                },
                flip: {
                    order: 600,
                    enabled: !0,
                ...
                computeStyle: {
                    ...
                    fn: function(t, e) {
                        ...
                        return t.attributes = nt({}, b, t.attributes), t.styles = nt({}, u, t.styles), t.oj2f_arrowStyles = nt({}, t.offsets.oj2f_arrow, t.oj2f_arrowStyles), t
                    },
                    gpuAcceleration: !0,
                    x: "bottom",
                    y: "right"
                ...
                applyStyle: {
                    ...
                    enabled: !0,
                    fn: function(t) {
                        return W(t.instance.popper, t.styles), U(t.instance.popper, t.attributes), t.oj2f_arrowElement && Object.keys(t.oj2f_arrowStyles).length && W(t.oj2f_arrowElement, t.oj2f_arrowStyles), t
                    },
...
var Util = function(t) {
    ...
    Tooltip = function(t) {
        ...
        var e = "tooltip",
            ...
            a = {
                animation: !0,
                template: '<div class="tooltip" role="tooltip"><div class="oj2f_arrow"></div><div class="tooltip-inner"></div></div>',
                trigger: "hover focus",
                title: "",
                delay: 0,
                html: !1,
    ...
    oj2f_popover = function(t) {
        var e = "oj2f_popover",
            n = ".bs.oj2f_popover",
            o = t.fn[e],
            i = new RegExp("(^|\\s)bs-oj2f_popover\\S+", "g"),
            r = t.extend({}, Tooltip.Default, {
                placement: "right",
                trigger: "click",
                content: "",
                template: '<div class="oj2f_popover" role="tooltip"><div class="oj2f_arrow"></div><h3 class="oj2f_popover-header"></h3><div class="oj2f_popover-body"></div></div>'
            }),
            ...
            p = {
                TITLE: ".oj2f_popover-header",
                CONTENT: ".oj2f_popover-body"
            },
            u = {
                HIDE: "hide" + n,
                HIDDEN: "hidden" + n,
            ...
            l = function(o) {
                ...
                return _inherits(l, o), l.prototype.isWithContent = function() {
                    ...
                    t(this.getTipElement()).addClass("bs-oj2f_popover-" + e)
                    ...
                    return this.each(function() {
                        var n = t(this).data("bs.oj2f_popover"),
                            o = "object" === (void 0 === e ? "undefined" : _typeof(e)) ? e : null;
                        if ((n || !/destroy|hide/.test(e)) && (n || (n = new l(this, o), t(this).data("bs.oj2f_popover", n)), "string" == typeof e)) {
                            if (void 0 === n[e]) throw new Error('No method named "' + e + '"');
                            n[e]()
                        }
                    })
...
! function(t, e) {
    ...
    return e = window.document,
        function() {
            function n(e) {
                this._showoj2f_popoverAndOverlay = bind(this._showoj2f_popoverAndOverlay, this);
                var n;
                try {
                ...
                this._options = t.extend({
                    ...
                    delay: !1,
                    basePath: "",
                    template: '<div class="oj2f_popover" role="tooltip"> <div class="oj2f_arrow" ></div> <h3 class="oj2f_popover-header" style="margin-top:0px;"></h3> <div class="oj2f_popover-body"></div> <div class="oj2f_popover-navigation"> <div class="oj2f_tour_btn-group"> <button class="oj2f_tour_btn oj2f_tour_btn-sm oj2f_tour_btn-secondary oj2f_tour_btn_next-success" data-role="prev">&laquo; Prev</button>&nbsp; <button class="oj2f_tour_btn oj2f_tour_btn-sm oj2f_tour_btn-secondary oj2f_tour_btn_next-success" data-role="next">Next &raquo;</button> <button class="oj2f_tour_btn oj2f_tour_btn-sm oj2f_tour_btn-secondary" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> </div>&nbsp;&nbsp; <button class="oj2f_tour_btn oj2f_tour_btn-sm oj2f_tour_btn-secondary oj2f_tour_btn_next-success" data-role="end">End tour</button> </div> </div>',
            ...
            return n.prototype.addSteps = function(t) {
                ...
                if (s = this.getStep(e)) return this._clearTimer(), r = this._makePromise(null != s.onHide ? s.onHide(this, e) : void 0), i = function(o) {
                    return function(i) {
                        var r, a;
                        if ((r = t(s.element)).data("bs.oj2f_popover") || (r = t("body")), r.oj2f_popover("dispose").removeClass("tour-" + o._options.name + "-element tour-" + o._options.name + "-" + e + "-element").removeData("bs.oj2f_popover"), s.reflex && t(s.reflexElement).removeClass("tour-step-element-reflex").off(o._reflexEvent(s.reflex) + ".tour-" + o._options.name), s.backdrop && ((a = null != n && o.getStep(n)) && a.backdrop && a.backdropElement === s.backdropElement || o._hideOverlayElement(s)), null != s.onHidden) return s.onHidden(o)
                    }
                ...
                return this.ended() ? (this._debug("Tour ended, showStep prevented."), this) : (a = this.getStep(t)) && (s = t < this._current, o = this._makePromise(null != a.onShow ? a.onShow(this, t) : void 0), this.setCurrentStep(t), n = function() {
                    ...
                    return function(n) {
                        ...
                        if (a.autoscroll ? e._scrollIntoView(t) : e._showoj2f_popoverAndOverlay(t), a.duration) return e.resume()
                    }
            ...
            }, n.prototype._showoj2f_popoverAndOverlay = function(t) {
                var e;
                if (this.getCurrentStep() === t && !this.ended()) return (e = this.getStep(t)).backdrop && this._showOverlayElement(e), this._showoj2f_popover(e, t), null != e.onShown && e.onShown(this), this._debug("Step " + (this._current + 1) + " of " + this._options.steps.length)
            }, n.prototype._showoj2f_popover = function(e, n) {
                var o, i, r;
                ...
                return this._debug("Scroll into view. ScrollTop: " + a + ". Element offset: " + s + ". Window height: " + u + "."), i = 0, t("body, html").stop(!0, !0).animate({
                    ...
                    return function() {
                        if (2 == ++i) return t._showoj2f_popoverAndOverlay(e), t._debug("Scroll into view.\nAnimation end element offset: " + n.offset().top + ".\nWindow height: " + o.height() + ".")
                    }
                }(this))
            }, n.prototype._initMouseNavigation = function() {
                var n;
                return n = this, t(e).off("click.tour-" + this._options.name, ".oj2f_popover.tour-" + this._options.name + " *[data-role='prev']").off("click.tour-" + this._options.name, ".oj2f_popover.tour-" + this._options.name + " *[data-role='next']").off("click.tour-" + this._options.name, ".oj2f_popover.tour-" + this._options.name + " *[data-role='end']").off("click.tour-" + this._options.name, ".oj2f_popover.tour-" + this._options.name + " *[data-role='pause-resume']").on("click.tour-" + this._options.name, ".oj2f_popover.tour-" + this._options.name + " *[data-role='next']", function(t) {
                    return function(e) {
                        return e.preventDefault(), t.next()
                    }
                }(this)).on("click.tour-" + this._options.name, ".oj2f_popover.tour-" + this._options.name + " *[data-role='prev']", function(t) {
                    return function(e) {
                        if (e.preventDefault(), t._current > 0) return t.prev()
                    }
                }(this)).on("click.tour-" + this._options.name, ".oj2f_popover.tour-" + this._options.name + " *[data-role='end']", function(t) {
                    return function(e) {
                        return e.preventDefault(), t.end()
                    }
                }(this)).on("click.tour-" + this._options.name, ".oj2f_popover.tour-" + this._options.name + " *[data-role='pause-resume']", function(e) {
                    var o;
